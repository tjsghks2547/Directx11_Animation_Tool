...
WCHAR g_CurrentFbxFileName[MAX_PATH] = {};  
bool  g_bFbxFileDragOnOff = { false };
	...
	_In_ int       nCmdShow)
{
    ...
    //io.KeyMap[ImGuiKey_Tab] = -1; // Tab 키 매핑 해제    
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_DROPFILES:  
    {
        ...
        {   
            ...
            const TCHAR* filePathconst; 
            
            filePathconst = const_cast<const wchar_t*>(filePath);    
            ...
            _tsplitpath_s(filePath, szDrive, MAX_PATH, szDir, MAX_PATH, g_CurrentFbxFileName, MAX_PATH, nullptr, 0);    

            g_bFbxFileDragOnOff = true;     
